...
import { CNodePropsTypeEnum, SlotRenderType } from '../const'
import { isPlainObject } from '../util/lodash'
import type { CSSType } from './base'
import type { CPageDataType } from './page'
...
const normalObj = () =>
    define('normalObj', (value: any) => {
        ...
        if (
            [CNodePropsTypeEnum.SLOT, CNodePropsTypeEnum.EXPRESSION, CNodePropsTypeEnum.FUNCTION].includes(value?.type)
        ) {
            return false
        }
