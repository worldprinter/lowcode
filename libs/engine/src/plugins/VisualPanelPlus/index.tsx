...
import type { CSSEditorRef, CSSVal } from '../../component/CSSEditor'
import { CSSEditor } from '../../component/CSSEditor'
import type { CSSPropertiesEditorRef } from '../../component/CSSPropertiesEditor'
// import { CSSPropertiesEditor } from '../../component/CSSPropertiesEditor'
import type { CSSPropertiesVariableBindEditorRef } from '../../component/CSSPropertiesVariableBindEditor'
import { CSSPropertiesVariableBindEditor } from '../../component/CSSPropertiesVariableBindEditor'
import type { CPluginCtx } from '../../core/pluginManager'
import type { StyleArr } from '../../utils/css'
import { formatCSSProperty, formatCssToNodeVal, formatNodeValToEditor, styleArr2Obj } from '../../utils/css'
...
export const VisualPanelPlus = (props: { node: CNode | CRootNode; pluginCtx: CPluginCtx }) => {
    ...
    return (
        <div className={styles.visualPanelBox}>
            ...
            >
                <Collapse.Panel
                    header={<span className={styles.header}>Style Variable Bind</span>}
                    key='origin-css-edit'
                >
